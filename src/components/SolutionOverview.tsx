              ...
              <div className="flex flex-col gap-3 md:gap-5">
                ...
                <div className="flex flex-col gap-3 md:gap-2">
                  ...
                  <SolutionFeature 
                    ...
                    subcopy="Streams employer and employee data through our proprietary rating engine in seconds, then recommends the right mix of medical, ancillary, and financial protection so every team walks away with coverage tailored to its needs."
                  />
                  <SolutionFeature 
