...
const layers: LayerDefinition[] = [
  {
    ...
    items: [
      ...
      {
        id: "partner-advisor-os",
        title: "Partner & Advisor OS",
        description: "Cakewalk provides advisors with a comprehensive operating system to sell and manage life insurance policies.",
        bullets: [
          "Rapid advisor onboarding and eligibility checks.",
          "Quoting tools and near real-time application tracking.",
          "CRM integrations and marketing automation.",
          "Advisor payment dashboards with next-day payments.",
          "Performance analytics and insights for every advisor.",
        ],
        footer: "This system improves advisor productivity, reduces manual effort, and lets advisors focus on client engagement to drive velocity.",
      },
      {
